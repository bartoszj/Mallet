...
- (void)testCGPoint
{
    ...
    [self compareVariable:&point ofType:@"CGPoint *" toSummary:@"(x = 1, y = 2)"];
}
...
- (void)testCGSize
{
    ...
    [self compareVariable:&size ofType:@"CGSize *" toSummary:@"(width = 3, height = 4)"];
}
...
- (void)testCGRect
{
    ...
    [self compareVariable:&rect ofType:@"CGRect *" toSummary:@"(origin = (x = 6, y = 7), size = (width = 8, height = 9))"];
}
...
- (void)testCGVector
{
    ...
    [self compareVariable:&vector ofType:@"CGVector *" toSummary:@"(dx = 3, dy = 5)"];
}
...
- (void)testCGAffineTransform
{
    ...
    [self compareVariable:&transofrm ofType:@"CGAffineTransform *" toSummary:@"([2, 3], [4, 5], [6, 7])"];
}
